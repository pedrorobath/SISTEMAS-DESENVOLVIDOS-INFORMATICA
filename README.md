...
O sistema também inclui funcionalidades como gestão de faturação, regras de negócio e geração de listas de participantes.
...
Uso de JDBC para ligação com base de dados
Interface responsiva com Bootstrap
Sistema de login e recuperação de senha
Validação de dados
Dashboard para administração e do Cliente.
o link abaixoo teras acesso do sistema:

https://drive.google.com/drive/folders/17Cb_mTw9WX_mcZrreR9yJhZRMGGZGpH2?usp=sharing
